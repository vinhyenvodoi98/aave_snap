                ...
                return (
                  <div style={{ display: 'flex', gap: 12 }}>
                    <button
                      ...
                      type='button'
                      className='rounded-xl border border-gray-300 px-4 shadow-sm'
                    >
                      {chain.hasIcon && (
                        <div
                          style={{
                    ...
                    <div className='relative' ref={dropdownRef}>
                      <button
                        ...
                        type='button'
                        className='inline-flex items-center rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50'
                      ...
                      >
                        ...
                        {account.ensAvatar ? (
                          ...
                          <img
                            ...
                            className='h-[30px] w-[30px] rounded-full border-2 bg-indigo-300'
                          />
                        )}
                      </button>
                      {isOpen && (
